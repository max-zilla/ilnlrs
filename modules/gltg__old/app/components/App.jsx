...
// import Search from '@geostreams/core__old/app/pages/Search';
...
// import RouteMismatch from '@geostreams/core__old/app/pages/RouteMismatch';
...
const App = () => <div> GLTG Geodashboard Core (Old) </div>
export default App;
